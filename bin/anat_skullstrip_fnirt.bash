...
# default parameters
WD=`defaultopt $WD .`
Reference=`defaultopt $Reference ${FSLDIR}/data/standard/MNI152_T1_1mm.nii.gz`
ReferenceMask=`defaultopt $ReferenceMask ${FSLDIR}/data/standard/MNI152_T1_1mm_brain_mask_dil.nii.gz`  # dilate to be conservative with final brain mask
Reference2mm=`defaultopt $Reference2mm ${FSLDIR}/data/standard/MNI152_T1_2mm.nii.gz`
Reference2mmMask=`defaultopt $Reference2mmMask ${FSLDIR}/data/standard/MNI152_T1_2mm_brain_mask_dil.nii.gz`  # dilate to be conservative with final brain mask
